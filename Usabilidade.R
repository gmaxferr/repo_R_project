...
pontuacoes = c(registo_p1, registo_p2, registo_p3, registo_p4, registo_p5)
...
pontuacoes = c(pesquisa_por_nome_p1, pesquisa_por_nome_p2, pesquisa_por_nome_p3, pesquisa_por_nome_p4, pesquisa_por_nome_p5)
...
pontuacoes = c(adicionar_carrinho_1_p1, adicionar_carrinho_1_p2, adicionar_carrinho_1_p3, adicionar_carrinho_1_p4, adicionar_carrinho_1_p5)
...
pontuacoes = c(pesquisa_por_autor_p1, pesquisa_por_autor_p2, pesquisa_por_autor_p3, pesquisa_por_autor_p4, pesquisa_por_autor_p5)
...
pontuacoes = c(selecionar_livro_autor_p1, selecionar_livro_autor_p2, selecionar_livro_autor_p3, selecionar_livro_autor_p4, selecionar_livro_autor_p5)
...
pontuacoes = c(adicionar_favoritos_p1, adicionar_favoritos_p2, adicionar_favoritos_p3, adicionar_favoritos_p4, adicionar_favoritos_p5)
...
pontuacoes = c(aceder_favoritos_p1, aceder_favoritos_p2, aceder_favoritos_p3, aceder_favoritos_p4, aceder_favoritos_p5)
...
pontuacoes = c(adicionar_carrinho_2_p1, adicionar_carrinho_2_p2, adicionar_carrinho_2_p3, adicionar_carrinho_2_p4, adicionar_carrinho_2_p5)
...
pontuacoes = c(remover_livro_carrinho_p1, remover_livro_carrinho_p2, remover_livro_carrinho_p3, remover_livro_carrinho_p4, remover_livro_carrinho_p5)
...
pontuacoes = c(iniciar_compra_p1, iniciar_compra_p2, iniciar_compra_p3, iniciar_compra_p4, iniciar_compra_p5)
...
boxplot(pontuacoes, ylim = c(0,40), names.arg = 1:5, xlab="Pontuacao", ylab="Quantidade")
